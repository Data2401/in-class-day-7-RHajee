...
plot(x_range, sin_wave, type = "l", col = 'darkred')
```
...
first_nums = 40:50
next_nums = seq(51,60)
combined_sums = c(first_nums, next_nums)
combined_sums [7]
combined_sums [5:8]
length_sums = length(combined_sums)
#new_vector = combined_sums[1:3]:length_sums - 3:length_sums
```
...
```{r}
die_roll = function(roll_count){
  die = 6:1
  s = sample(die, roll_count, replace = T)
  return(s)
}
die_roll(1)
```
...
roll_comp = function(name_1, name_2){
  die = 6:1
  player_1 = name_1
  player_2 = name_2
